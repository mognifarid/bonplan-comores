...
export function ListingCard({ listing }: ListingCardProps) {
  ...
  const getBoostBadge = () => {
    switch (listing.boost) {
      case 'vedette':
        return (
          <Badge className="bg-gradient-premium text-accent-foreground gap-1 border-0">
      ...
      case 'urgent':
        return (
          <Badge className="bg-gradient-urgent text-destructive-foreground gap-1 border-0">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center justify-between text-sm text-muted-foreground">
          <div className="flex items-center gap-1">
            ...
            <span>{listing.city}, {islandLabel}</span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <span className="flex items-center gap-1">
              ...
              {formatDistanceToNow(listing.createdAt, { addSuffix: true, locale: fr })}
            </span>
          </div>
        </div>
      </div>
