              ...
              {showPhone && phoneNumber ? (
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      ...
                      <a href={`https://wa.me/${phoneNumber.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(`Bonjour, je suis intéressé(e) par votre annonce "${listing.title}" à ${formatPrice(listing.price)}. Est-elle toujours disponible ?`)}`} target="_blank" rel="noopener noreferrer">
